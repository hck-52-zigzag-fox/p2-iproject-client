...
export default {
    ...
    props: ['log'],
    methods: {
        ...mapActions(useCicoStore, ['deleteLog'])
    }
}
</script>
...
<template>
    ...
    <div class="block max-w-fit p-6 bg-white border border-gray-200 rounded-lg shadow-md hover:bg-gray-100
        ...
        <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full" @click="deleteLog(log.id)">
            DELETE
        </button>
    </div>
