    ...
    <section class="text-gray-600">
        <div class="container px-5 py-5 mx-auto">
            <div class="flex flex-col text-center w-full mb-5">
                ...
                <h1 class="sm:text-xl font-medium text-gray-900">Your Total Daily Energy Expenditure (TDEE) : {{
                        Math.floor(calcResult)
                }} calories</h1>
            </div>
        </div>
    </section>
    ...
    <div class="container flex justify-center items-center">
        ...
        <div class="w-full max-w-xs">
            <form action="" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4"
                ...
                <div class="mb-4">
                    <label for="weeklyPhysicalActivity" class="block text-gray-700 text-sm font-bold mb-2">Weekly
                        Physical
                        Activity</label>
                ...
                <button type="submit"
                    class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded flex justify-center container">Calculate</button>
            </form>
        </div>
    </div>
