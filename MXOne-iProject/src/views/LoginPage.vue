...
<template>
  ...
  >
    ...
    >
      <div
        class="flex flex-col shadow-md px-4 sm:px-6 md:px-8 lg:px-10 py-8 rounded-3xl w-50 max-w-md bg-black bg-opacity-80"
      >
      ...
      <div class="flex justify-center items-center mt-6">
        <a
          href="#"
          target="_blank"
          class="inline-flex items-center font-medium text-xs text-center text-stone-200"
        >
          <span class="ml-2"
            >You have an account?
