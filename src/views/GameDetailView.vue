...
<template>
  <div class="row justify-content-center p-2 m-2">
    ...
    <div class="col-md-6">
      ...
      <p>
        <span class="text-secondary">Released Date : </span>{{ game.released }}
      </p>
      <p>
        <span class="text-secondary">Developer : </span>
        <a :href="game.developer.link" class="link-info text-decoration-none">{{
          game.developer.name
        }}</a>
      </p>
      <p>
        <span class="text-secondary">Publisher : </span>
        <a :href="game.publisher.link" class="link-info text-decoration-none">{{
          game.publisher.name
        }}</a>
      </p>
